      ...
      <div class="manager-main-left">
        ...
        :default-openeds="['1','2']"
          ...
          <el-sub-menu index="1">
            ...
            <el-menu-item index="/manager/notice">系统公告</el-menu-item><!--el-menu菜单->index.js路由->category.vue页面-->
...
<script setup>
  ...
  const data = reactive({
    // 核心修复：先获取值 → 判空 → 仅对字符串执行JSON.parse
    user: (() => {
      const userStr = localStorage.getItem('xm-user');
      // 只有存在且是字符串时才解析，否则返回空对象
